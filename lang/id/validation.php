...
return [
    ...
    'between.array' => 'Konten ini harus memiliki panjang di antara :min dan :max item.',
    'between.file' => 'Berkas ini harus berukuran di antara :min dan :max kilobyte.',
    'between.numeric' => 'Nilai ini harus bernilai di antara :min dan :max.',
    'between.string' => 'String ini harus memiliki panjang di antara :min dan :max karakter.',
    ...
    'gt.array' => 'Konten harus memiliki lebih dari :value item.',
    'gt.file' => 'Ukuran berkas harus berisi lebih besar dari :value kilobyte.',
    'gt.numeric' => 'Nilai harus lebih besar dari :value.',
    'gt.string' => 'String harus berisi lebih besar dari :value karakter.',
    'gte.array' => 'Konten harus memiliki :value item atau lebih.',
    'gte.file' => 'Ukuran konten harus berisi lebih besar dari atau setara :value kilobyte.',
    'gte.numeric' => 'Nilai harus berisi lebih besar dari atau setara :value.',
    'gte.string' => 'String harus berisi lebih besar dari atau setara :value karakter.',
    ...
    'lt.array' => 'Panjang array harus kurang dari :value item.',
    'lt.file' => 'Ukuran konten harus berisi kurang dari :value kilobyte.',
    'lt.numeric' => 'Nilai harus berisi kurang dari :value.',
    'lt.string' => 'String harus berisi kurang dari :value karakter.',
    'lte.array' => 'Panjang array harus lebih dari :value item.',
    'lte.file' => 'Ukuran konten harus berisi kurang dari atau setara :value kilobyte.',
    'lte.numeric' => 'Nilai harus berisi kurang dari atau setara :value.',
    'lte.string' => 'String harus berisi kurang dari atau setara :value karakter.',
    ...
    'min.array' => 'Panjang array harus minimal :min item.',
    'min.file' => 'Ukuran konten harus berisi minimal :min kilobyte.',
    'min.numeric' => 'Nilai harus berisi minimal :min.',
    'min.string' => 'String harus berisi minimal :min karakter.',
    ...
    'password.letters' => 'Isian password ini harus memiliki setidaknya satu karakter.',
    'password.mixed' => 'Isian password ini harus memiliki setidaknya satu huruf kapital dan satu huruf kecil.',
    'password.numbers' => 'Isian password ini harus memiliki setidaknya satu angka.',
    'password.symbols' => 'Isian password ini harus memiliki setidaknya satu simbol.',
    'password.uncompromised' => 'Isian password ini telah muncul di kebocoran data. Silahkan memilih isian password yang berbeda.',
    ...
    'size.array' => 'Panjang array harus memiliki :size item.',
    'size.file' => 'Ukuran konten harus berisi :size kilobyte.',
    'size.numeric' => 'Nilai harus berisi :size.',
    'size.string' => 'String harus berisi :size karakter.',
